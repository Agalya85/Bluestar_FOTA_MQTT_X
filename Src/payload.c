...
//			fotaPloadFlag = FALSE;
//		}
//		if(LowVoltgUploadFlag == TRUE)
//		{
//			strcat((char *)systemPayload,"ALERT : ");
//			strcat((char *)systemPayload,"Low Input Supply or Internal Battery Supply, FOTA FAIL.");
//			strcat((char *)systemPayload,(char * )",");
...
//			strcat((char *)systemPayload,(char * )voltage);
//			strcat((char *)systemPayload,(char * )",");
//			LowVoltgUploadFlag = FALSE;
//		}
//		if(strlen(gsmInstance.u32GSMHttpResponseCode) > 1)
//		{
//			strcat((char *)systemPayload,"ALERT : ");
//			strcat((char *)systemPayload,"FOTA FAIl , GET HTTP Resp Code :");
//			strcat((char *)systemPayload,(char * )gsmInstance.u32GSMHttpResponseCode);
//			strcat((char *)systemPayload,(char * )",");
//			strcpy(gsmInstance.u32GSMHttpResponseCode,"0");
//		}
