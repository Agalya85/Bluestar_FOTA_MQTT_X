...
#define GSM_MQTT_RESPONSE_CODE_SIZE (8)
...
//	enmGSMSTATE_NETOPEN,
//	enmGSMSTATE_NETOPENCHECK,
	/*MQTT Sequence*/
//	enmGSMSTATE_CMQTTSTOP,
	enmGSMSTATE_CMQTTSTART,
	enmGSMSTATE_CMQTTACCQ,
//	enmGSMSTATE_CMQTTWILLTOPIC,
//	enmGSMSTATE_CMQTTWILLMSG,
	enmGSMSTATE_CMQTTCONNECT,
	/*Subscribe*/
	enmGSMSTATE_CMQTTSUBTOPIC,
	enmGSMSTATE_CMQTTSUBTOPICNAME,
	enmGSMSTATE_CMQTTSUB,
	enmGSMSTATE_CMQTTTOPIC,
	enmGSMSTATE_CMQTTTOPICNAME,
    enmGSMSTATE_CMQTTSUBCOMMAND,
	enmGSMSTATE_SENDDATA,
	//enmGSMSTATE_CMQTTPAYLOAD,
	enmGSMSTATE_CMQTTPUB,
...
//	char u32GSMHttpResponseCode[3];
	char agsmMQTTRequestStatus[GSM_MQTT_RESPONSE_CODE_SIZE]	;				/* Stores HTTP Response code */
	char u32GSMMQTTResponseCode[3];
	...
	uint8_t u8MQTTStartStatus;    /*MQTT Status*/												/* HTTP Status */
	uint8_t u8AttemptFota;
	uint8_t u8IncrementGsmState;
	uint8_t u8IllegalHttpResponseCounter;
	uint8_t u8IllegalMqttResponseCounter;
	uint16_t u8LastHttpResponseCode;
	uint16_t u8LastMqttResponseCode;
...
//void restoreMQTTURLforData(void);
