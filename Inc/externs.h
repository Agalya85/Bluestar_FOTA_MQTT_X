...
//extern uint32_t ConfigFileSizeBytes;
extern strctADC ADCValues;
...
extern uint32_t u32ConfigFileReadComplete ;
extern _Bool gu8PowerOnFlag;
extern uint8_t NoOfCANID;
extern _Bool fotaPloadFlag;

extern _Bool LowVoltgUploadFlag;
